 ...
 * @private
 */
function getStringFromTypedArray(uint8Array: Uint8Array, byteOffset?: number, byteLength?: number) {
...
getStringFromTypedArray.decodeWithTextDecoder = function(view: any) {
    var decoder = new TextDecoder('utf-8');
    return decoder.decode(view);
};

getStringFromTypedArray.decodeWithFromCharCode = function(view: any) {
    var result = '';
